// Shared prompt parser for Nano Banana — single source of truth.
// Canonical version (was duplicated, drifted, in generate.js + prompt.js).
// Plain heuristic parser: no LLMs, no API calls, no tokens.
